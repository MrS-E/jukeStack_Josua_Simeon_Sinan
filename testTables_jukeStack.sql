...
2.0		2023-01-11	JP	updated NFTSong Inserts
...
insert into TNFTSongs values('qDzUQ37dfQk7Vek4','Juan Läuchli', 'Freiimpro', '0:5:33', '2021', '/var/sftp/tmp/Freiimpro.mp3'); -- in the real data the NFToken would be generated by a script
insert into TNFTSongs values('qDz2237dfQk7Vek4','Ludwig van Beethoven', 'Für Elise', '0:2:53', '1810', '/var/sftp/tmp/Ludwig_van_Beethoven_Für_Elise.mp3'); -- in the real data the NFToken would be generated by a script
...
insert into TNFTSongs values('iPPrbc9ggugNVszb', 'Abba', 'Waterloo', '0:2:46','1980', null);
...
select * from TUsers where UsMail = 'Francois@bluewin.ch';
-- 3
insert into TNFTSongs values('NFTIanSpe0891995', 'Ian Kelly', 'Speak your Mind', '00:04:08','2008',null);
